...
#define MAILBOX_BARO       0
#define MAILBOX_BARO_SIZE 10
#define MAILBOX_IMU        1
#define MAILBOX_IMU_SIZE  10
#define MAILBOX_GPS        2
#define MAILBOX_GPS_SIZE  10
#define MAILBOX_MSG_SIZE  36
